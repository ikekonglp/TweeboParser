...
class FeatureEncoder {
 public:
  ...
  // LPK: The thing happened here is basically:
  // type: What kind of feature it is, like the head pos tag, or the mod word form,
  // or joint the two, kind of like that
  // flag: This one decided where the feature goes to, goes to arc, or grandparent,
  // or sibling, something like that
  // The remaining part is basically the replacement for the string things, and that
  // is why we need to map the POS, the word form, things like that to the numbers.
