...
class TokenDictionary : public Dictionary {
 public:
  ...
  void AllowGrowth() {
    ...
    brownall_alphabet_.AllowGrowth();
    ...
    brown4_alphabet_.AllowGrowth();
    brown6_alphabet_.AllowGrowth();
  ...
  int GetBrownAllId(const string &brownall) const { return brownall_alphabet_.Lookup(brownall); };
  ...
  int GetBrown4Id(const string &brown4) const { return brown4_alphabet_.Lookup(brown4); };
  int GetBrown6Id(const string &brown6) const { return brown6_alphabet_.Lookup(brown6); };
 ...
 private:
  ...
  Alphabet brown4_alphabet_;
  Alphabet brown6_alphabet_;
